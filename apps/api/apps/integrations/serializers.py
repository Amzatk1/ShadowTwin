...
class IntegrationConnectionSerializer(serializers.Serializer):
    ...
    syncHealthState = serializers.CharField()
    ...
    lastSyncStatus = serializers.CharField()
    lastSyncStartedAt = serializers.DateTimeField(allow_null=True)
    lastSyncCompletedAt = serializers.DateTimeField(allow_null=True)
    lastSyncErrorCode = serializers.CharField(allow_blank=True)
    syncMode = serializers.CharField()
    syncCursor = serializers.JSONField()
